...
from manager.audio_manager import DialogSession
...
async def main() -> None:
    ...
    parser.add_argument("--audio", type=str, default="",
                        help="audio file send to server, if not set, will use microphone input.")

    args = parser.parse_args()

    session = DialogSession(output_audio_format=args.format, audio_file_path=args.audio)
    await session.start()
